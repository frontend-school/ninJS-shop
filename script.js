...
function createDiv () {
    ...
    var randLeft = Math.floor(Math.random() * 1000); // generate random number from 0 to 1000
    divHolder['div' + i].style.left = randLeft;   // make left offset random
    ...
    switch (randClassName) {
        case 1:
            ...
            break;
        case 2:
            //var randWidthTri = Math.floor(Math.random() * (300-50) + 50); // div random width
        ...
        case 3:
            ...
            var randWidthCircle = Math.floor(Math.random() * (300-50) + 50); // div.circle random width and height
            divHolder['div' + i].style.width = randWidthCircle;
            divHolder['div' + i].style.height = randWidthCircle;
            randSpeedFunc();
            break;
    }
