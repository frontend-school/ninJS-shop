var router = require('./core/router.js'),
    ...
    products = require('./components/partials/products/index.js'),
    pagination = require('./components/partials/pagination/index.js'),
    singleProduct = require('./components/partials/single-product/controller.js'),
    filters = require('./components//partials/filters/index.js'),
